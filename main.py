...
def main():
    ...
    if st.button("Generate AB test experiment") and api_key and st.session_state.num_people:
    ...
    if st.session_state.gen_email_campaign_a and st.session_state.gen_email_campaign_b and st.button("Generate AB test Users Personas") and st.session_state.num_people and api_key:
